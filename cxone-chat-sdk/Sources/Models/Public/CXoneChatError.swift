...
public enum CXoneChatError: LocalizedError, Equatable {
    ...
    /// An analytics event has been generated when no visitor id was available.
    ///
    /// - Attention: ``ConnectionProvider/connect(environment:brandId:channelId:)`` or
    /// ``ConnectionProvider/connect(chatURL:socketURL:brandId:channelId:)``
    /// must be called before any other analytics events are generated.
    ...
    public var errorDescription: String? {
        ...
        case .missingVisitorId:
            return "An analytics event was generated with no visitor id"
        }
    }
